...
$asfj:null,
$isfj:true}
$$.O2={"":"a;Hg,oL,Y7,N0,yc,Xz,Ai,EF,q2,i2,vd,XC,w2",
...
u=$globalState.N0!=null&&!$.xC($.F8($globalState.N0),y.gJD())
t=this.c
z.a=t
z.b=x
if(u){z.a=$.Gy(z.a)
...
z.u(z,a,x)
z=a.gvc()
return["map",x,this.Xu(z.br(z)),this.Xu($.F(a.gUQ(a),!0))]},
...
z=$.U6(b)
y=z.gB(b)
for(x=0;$.Z9c.C(x,y);++x)z.u(b,x,this.fQ(z.t(b,x)))
return b},
...
e=$.U6(d)
x=e.gB(d)
for(y=$.U6(f),w=0;$.Z9c.C(w,x);++w)c.u(c,this.fQ(e.t(d,w)),this.fQ(y.t(f,w)))
return c}}}
$$.yH={"":"a;wk,Ch,aQ?",
...
for(y=0;$.Z9c.C(y,this.gB(a));++y){x=this.t(a,y)
...
z=$.A($)
$.U9u.sB(z,e)
for(y=$.Qc(b),x=0;$.Z9c.C(x,e);++x){w=this.t(d,y.g(b,x))
...
if(b){z=$.A($)
$.U9u.sB(z,$.mQ($.xH(this.xn,this.JW),this.FQ.length-1))}else z=$.A($.mQ($.xH(this.xn,this.JW),this.FQ.length-1))
this.Rg(z)
return z},
br:function(a){return this.tt(a,!0)},
...
return z>=y},
tk:function(a,b,c){return $.Z9c.F(b,c)},
n:function(a,b){if(b==null)return!1
...
x.Mb=!0
x.AG(z)}else{if(x.Mb)$.vh($.w("Future already completed"))
x.Mb=!0
x.aV(a)}}}
$$.iO={"":"Tp;d",
...
UZ:function(a,b,c){$.bQ($.U9u.D6(this.gwB(),b,c),new $.GS())},
...
$.rf=function(a){var z
$.Sa().push(a)
if($.Sa().length===1){z=$.Z9c.Z($.U3.pM,1000)
if(z<0)z=0
$.cy(z,new $.Ef())}}
...
if(e!=null)$.Pda.aN(e,new $.bU(y))
if(d!=null){x=$.Caa.aM(y)
$.JE(x.MP,x.mE,d,x.Gd)}x=$.U0.aM(y)
...
e.push(b[y])}return e}
$.E2=function(){var z=document.querySelector("#getWords")
z.gVl
z=$.U9.aM(z)
$.JE(z.MP,z.mE,$.tB,z.Gd)
$.Ft=document.querySelector("#wordList")}
$.MC=function(a){$.Kn("portmanteaux_simple.json",null,null).ml($.F5).OA($.yR)}
...
for(z=$.U6(b),y=0;$.Z9c.C(y,z.gB(b));++y){x=$.OG($.Ft)
w=document.createElement("li")
